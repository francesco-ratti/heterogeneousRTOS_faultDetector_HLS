...
entity run_runTestAfterInit_Block_entry1012_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of run_runTestAfterInit_Block_entry1012_proc is 
...
begin
    ...
    ap_return_3_assign_proc : process(n_regions_V_q0, ap_CS_fsm_state2, ap_return_3_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
