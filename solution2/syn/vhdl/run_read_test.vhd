...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((exitcond1_fu_385_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                tmp_51_reg_602 <= testStream_TDATA(127 downto 96);
                tmp_52_reg_607 <= testStream_TDATA(159 downto 128);
                tmp_53_reg_612 <= testStream_TDATA(191 downto 160);
                tmp_54_reg_617 <= testStream_TDATA(223 downto 192);
                tmp_55_reg_622 <= testStream_TDATA(255 downto 224);
                tmp_56_reg_627 <= testStream_TDATA(287 downto 256);
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, testStream_TVALID, ap_CS_fsm_state5, exitcond1_fu_385_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state5 => 
                if (((exitcond1_fu_385_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state5, exitcond1_fu_385_p2)
    begin
        if (((exitcond1_fu_385_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state5, exitcond1_fu_385_p2)
    begin
        if (((exitcond1_fu_385_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    tmp_fu_258_p4 <= testStream_TDATA(63 downto 32);
    tmp_s_fu_273_p4 <= testStream_TDATA(95 downto 64);
end behav;
