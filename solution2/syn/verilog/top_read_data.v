...
reg   [0:0] icmp_ln526_reg_173;
reg    gmem_blk_n_AR;
wire    ap_CS_fsm_state2;
reg    gmem_blk_n_R;
wire    ap_CS_fsm_state72;
reg    startCopy_blk_n;
wire   [0:0] icmp_ln526_fu_114_p2;
reg   [255:0] tmp_s_reg_183;
reg   [39:0] tmp_47_reg_188;
wire   [23:0] trunc_ln174_fu_161_p1;
reg   [23:0] trunc_ln174_reg_193;
wire  signed [63:0] p_cast_cast_fu_130_p1;
reg    ap_block_state2_io;
reg    ap_block_state1;
reg   [7:0] copying_preg;
reg    ap_block_state73;
wire   [57:0] p_cast_fu_120_p4;
reg   [72:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((sourceStream_full_n == 1'b0) & (icmp_ln526_reg_173 == 1'd0)) & (1'b1 == ap_CS_fsm_state73))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((sourceStream_full_n == 1'b0) & (icmp_ln526_reg_173 == 1'd0)) & (1'b1 == ap_CS_fsm_state73) & (icmp_ln526_reg_173 == 1'd0))) begin
            copying_preg <= 8'd0;
        end else if (((1'b1 == ap_CS_fsm_state72) & (m_axi_gmem_RVALID == 1'b1))) begin
            copying_preg <= 8'd255;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state72)) begin
        tmp_47_reg_188 <= {{m_axi_gmem_RDATA[71:32]}};
        tmp_s_reg_183 <= {{m_axi_gmem_RDATA[351:96]}};
...
always @ (*) begin
    if (((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (startCopy_ap_vld == 1'b0))) begin
...
always @ (*) begin
    if (((sourceStream_full_n == 1'b0) & (icmp_ln526_reg_173 == 1'd0))) begin
...
always @ (*) begin
    if ((~((sourceStream_full_n == 1'b0) & (icmp_ln526_reg_173 == 1'd0)) & (1'b1 == ap_CS_fsm_state73))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((~((sourceStream_full_n == 1'b0) & (icmp_ln526_reg_173 == 1'd0)) & (1'b1 == ap_CS_fsm_state73) & (icmp_ln526_reg_173 == 1'd0)) | ((1'b1 == ap_CS_fsm_state72) & (m_axi_gmem_RVALID == 1'b1)))) begin
        copying_ap_vld = 1'b1;
    end else begin
        copying_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln526_reg_173 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln526_reg_173 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state73) & (icmp_ln526_reg_173 == 1'd0))) begin
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (startCopy_ap_vld == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln526_reg_173 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state73;
            end else if (((1'b0 == ap_block_state2_io) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln526_reg_173 == 1'd0))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (startCopy_ap_vld == 1'b0));
end

always @ (*) begin
    ap_block_state2_io = ((icmp_ln526_reg_173 == 1'd0) & (m_axi_gmem_ARREADY == 1'b0));
end

always @ (*) begin
    ap_block_state73 = ((sourceStream_full_n == 1'b0) & (icmp_ln526_reg_173 == 1'd0));
end

assign icmp_ln526_fu_114_p2 = ((startCopy == 8'd0) ? 1'b1 : 1'b0);

assign m_axi_gmem_ARADDR = p_cast_cast_fu_130_p1;
...
assign p_cast_cast_fu_130_p1 = $signed(p_cast_fu_120_p4);

assign p_cast_fu_120_p4 = {{inputAOV[63:6]}};

assign sourceStream_din = {{{tmp_s_reg_183}, {tmp_47_reg_188}}, {trunc_ln174_reg_193}};

assign trunc_ln174_fu_161_p1 = m_axi_gmem_RDATA[23:0];

endmodule //top_read_data
