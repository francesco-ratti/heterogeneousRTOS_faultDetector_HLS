...
module run_runTestAfterInit_Block_entry12_proc4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [511:0] gmem_addr_read_reg_405;
wire   [7:0] empty_fu_230_p1;
reg   [7:0] empty_reg_411;
reg   [31:0] tmp_reg_417;
reg   [31:0] tmp_23_reg_422;
reg   [31:0] tmp_s_reg_427;
reg   [31:0] tmp_56_reg_432;
reg   [31:0] tmp_57_reg_437;
reg   [31:0] tmp_58_reg_442;
reg   [31:0] tmp_59_reg_447;
reg   [31:0] tmp_60_reg_452;
reg   [7:0] tmp_61_reg_457;
reg   [15:0] agg_tmp_reg_462;
reg   [7:0] tmp_62_reg_467;
wire   [31:0] contr_AOV_fu_344_p1;
reg   [31:0] contr_AOV_reg_472;
wire    ap_CS_fsm_state72;
wire   [31:0] contr_AOV_1_fu_347_p1;
reg   [31:0] contr_AOV_1_reg_478;
wire   [31:0] contr_AOV_2_fu_350_p1;
reg   [31:0] contr_AOV_2_reg_484;
wire   [31:0] contr_AOV_3_fu_353_p1;
reg   [31:0] contr_AOV_3_reg_490;
wire   [31:0] contr_AOV_4_fu_356_p1;
reg   [31:0] contr_AOV_4_reg_496;
wire   [31:0] contr_AOV_5_fu_359_p1;
reg   [31:0] contr_AOV_5_reg_502;
wire   [31:0] contr_AOV_6_fu_362_p1;
reg   [31:0] contr_AOV_6_reg_508;
wire   [31:0] contr_AOV_7_fu_365_p1;
reg   [31:0] contr_AOV_7_reg_514;
wire   [0:0] icmp_ln576_fu_368_p2;
reg   [0:0] icmp_ln576_reg_520;
reg   [3:0] trunc_ln_reg_529;
wire    ap_CS_fsm_state73;
wire   [0:0] icmp_ln576_1_fu_386_p2;
reg   [0:0] icmp_ln576_1_reg_534;
wire   [5:0] trunc_ln577_fu_396_p1;
reg   [5:0] trunc_ln577_reg_543;
reg   [7:0] n_regions_V_load_reg_548;
wire    ap_CS_fsm_state74;
wire   [0:0] grp_run_test_fu_166_ap_return;
reg   [0:0] error_reg_553;
wire    ap_CS_fsm_state75;
wire    grp_run_test_fu_166_ap_start;
wire    grp_run_test_fu_166_ap_done;
wire    grp_run_test_fu_166_ap_idle;
wire    grp_run_test_fu_166_ap_ready;
wire   [11:0] grp_run_test_fu_166_regions_min_0_address0;
wire    grp_run_test_fu_166_regions_min_0_ce0;
wire   [11:0] grp_run_test_fu_166_regions_min_1_address0;
wire    grp_run_test_fu_166_regions_min_1_ce0;
wire   [11:0] grp_run_test_fu_166_regions_max_0_address0;
wire    grp_run_test_fu_166_regions_max_0_ce0;
wire   [11:0] grp_run_test_fu_166_regions_max_1_address0;
wire    grp_run_test_fu_166_regions_max_1_ce0;
wire    grp_writeOutcome_fu_189_ap_start;
wire    grp_writeOutcome_fu_189_ap_done;
wire    grp_writeOutcome_fu_189_ap_idle;
wire    grp_writeOutcome_fu_189_ap_ready;
wire   [3:0] grp_writeOutcome_fu_189_errorInTask_address0;
wire    grp_writeOutcome_fu_189_errorInTask_ce0;
wire    grp_writeOutcome_fu_189_errorInTask_we0;
wire   [7:0] grp_writeOutcome_fu_189_errorInTask_d0;
wire   [3:0] grp_writeOutcome_fu_189_outcomeInRam_address0;
wire    grp_writeOutcome_fu_189_outcomeInRam_ce0;
wire   [35:0] grp_writeOutcome_fu_189_outcomeInRam_we0;
wire   [287:0] grp_writeOutcome_fu_189_outcomeInRam_d0;
reg    grp_run_test_fu_166_ap_start_reg;
reg    grp_writeOutcome_fu_189_ap_start_reg;
wire    ap_CS_fsm_state76;
wire    ap_CS_fsm_state77;
wire   [63:0] zext_ln587_fu_373_p1;
wire   [63:0] zext_ln587_1_fu_392_p1;
wire  signed [63:0] p_cast_cast_fu_219_p1;
reg    ap_block_state1;
wire   [57:0] p_cast_fu_209_p4;
reg    ap_predicate_op196_call_state77;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 77'd1;
#0 grp_run_test_fu_166_ap_start_reg = 1'b0;
#0 grp_writeOutcome_fu_189_ap_start_reg = 1'b0;
end

run_run_test grp_run_test_fu_166(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
run_writeOutcome grp_writeOutcome_fu_189(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_run_test_fu_166_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state74)) begin
            grp_run_test_fu_166_ap_start_reg <= 1'b1;
        end else if ((grp_run_test_fu_166_ap_ready == 1'b1)) begin
            grp_run_test_fu_166_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_writeOutcome_fu_189_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state76)) begin
            grp_writeOutcome_fu_189_ap_start_reg <= 1'b1;
        end else if ((grp_writeOutcome_fu_189_ap_ready == 1'b1)) begin
            grp_writeOutcome_fu_189_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        agg_tmp_reg_462 <= {{m_axi_gmem_RDATA[31:16]}};
        empty_reg_411 <= empty_fu_230_p1;
        gmem_addr_read_reg_405 <= m_axi_gmem_RDATA;
        tmp_23_reg_422 <= {{m_axi_gmem_RDATA[127:96]}};
        tmp_56_reg_432 <= {{m_axi_gmem_RDATA[191:160]}};
        tmp_57_reg_437 <= {{m_axi_gmem_RDATA[223:192]}};
        tmp_58_reg_442 <= {{m_axi_gmem_RDATA[255:224]}};
        tmp_59_reg_447 <= {{m_axi_gmem_RDATA[287:256]}};
        tmp_60_reg_452 <= {{m_axi_gmem_RDATA[319:288]}};
        tmp_61_reg_457 <= {{m_axi_gmem_RDATA[15:8]}};
        tmp_62_reg_467 <= {{m_axi_gmem_RDATA[39:32]}};
        tmp_reg_417 <= {{m_axi_gmem_RDATA[95:64]}};
        tmp_s_reg_427 <= {{m_axi_gmem_RDATA[159:128]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state73)) begin
        ...
        trunc_ln_reg_529 <= {{gmem_addr_read_reg_405[11:8]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln576_1_fu_386_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state73))) begin
...
always @ (*) begin
    if ((grp_run_test_fu_166_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state72)) begin
        errorInTask_address0 = zext_ln587_fu_373_p1;
    end else if (((icmp_ln576_1_reg_534 == 1'd1) & (icmp_ln576_reg_520 == 1'd1) & (1'b1 == ap_CS_fsm_state77))) begin
        errorInTask_address0 = grp_writeOutcome_fu_189_errorInTask_address0;
    end else begin
...
always @ (*) begin
    if (((icmp_ln576_1_reg_534 == 1'd1) & (icmp_ln576_reg_520 == 1'd1) & (1'b1 == ap_CS_fsm_state77))) begin
        errorInTask_we0 = grp_writeOutcome_fu_189_errorInTask_we0;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state72 : begin
            if (((icmp_ln576_fu_368_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state72))) begin
        ...
        ap_ST_fsm_state73 : begin
            if (((icmp_ln576_1_fu_386_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state73))) begin
                ap_NS_fsm = ap_ST_fsm_state77;
            end else begin
        ...
        ap_ST_fsm_state75 : begin
            if (((grp_run_test_fu_166_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state75))) begin
...
always @ (*) begin
    ap_block_state77_on_subcall_done = ((ap_predicate_op196_call_state77 == 1'b1) & (grp_writeOutcome_fu_189_ap_done == 1'b0));
end

always @ (*) begin
    ap_predicate_op196_call_state77 = ((icmp_ln576_1_reg_534 == 1'd1) & (icmp_ln576_reg_520 == 1'd1));
end

assign contr_AOV_1_fu_347_p1 = tmp_23_reg_422;

assign contr_AOV_2_fu_350_p1 = tmp_s_reg_427;

assign contr_AOV_3_fu_353_p1 = tmp_56_reg_432;

assign contr_AOV_4_fu_356_p1 = tmp_57_reg_437;

assign contr_AOV_5_fu_359_p1 = tmp_58_reg_442;

assign contr_AOV_6_fu_362_p1 = tmp_59_reg_447;

assign contr_AOV_7_fu_365_p1 = tmp_60_reg_452;

assign contr_AOV_fu_344_p1 = tmp_reg_417;

assign empty_fu_230_p1 = m_axi_gmem_RDATA[7:0];

assign errorInTask_d0 = grp_writeOutcome_fu_189_errorInTask_d0;

assign grp_run_test_fu_166_ap_start = grp_run_test_fu_166_ap_start_reg;

assign grp_writeOutcome_fu_189_ap_start = grp_writeOutcome_fu_189_ap_start_reg;

assign icmp_ln576_1_fu_386_p2 = ((errorInTask_q0 == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln576_fu_368_p2 = ((tmp_62_reg_467 == 8'd2) ? 1'b1 : 1'b0);

assign m_axi_gmem_ARADDR = p_cast_cast_fu_219_p1;
...
assign n_regions_V_address0 = zext_ln587_1_fu_392_p1;

assign outcomeInRam_address0 = grp_writeOutcome_fu_189_outcomeInRam_address0;

assign outcomeInRam_ce0 = grp_writeOutcome_fu_189_outcomeInRam_ce0;

assign outcomeInRam_d0 = grp_writeOutcome_fu_189_outcomeInRam_d0;

assign outcomeInRam_we0 = grp_writeOutcome_fu_189_outcomeInRam_we0;

assign p_cast_cast_fu_219_p1 = $signed(p_cast_fu_209_p4);

assign p_cast_fu_209_p4 = {{inputAOV[63:6]}};

assign regions_1_address0 = grp_run_test_fu_166_regions_min_1_address0;

assign regions_1_ce0 = grp_run_test_fu_166_regions_min_1_ce0;

assign regions_2_address0 = grp_run_test_fu_166_regions_max_0_address0;

assign regions_2_ce0 = grp_run_test_fu_166_regions_max_0_ce0;

assign regions_3_address0 = grp_run_test_fu_166_regions_max_1_address0;

assign regions_3_ce0 = grp_run_test_fu_166_regions_max_1_ce0;

assign regions_address0 = grp_run_test_fu_166_regions_min_0_address0;

assign regions_ce0 = grp_run_test_fu_166_regions_min_0_ce0;

assign trunc_ln577_fu_396_p1 = gmem_addr_read_reg_405[5:0];

assign zext_ln587_1_fu_392_p1 = empty_reg_411;

assign zext_ln587_fu_373_p1 = tmp_61_reg_457;

endmodule //run_runTestAfterInit_Block_entry12_proc4
