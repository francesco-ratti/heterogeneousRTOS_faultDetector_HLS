...
wire   [0:0] icmp_ln89_1_fu_216_p2;
reg   [0:0] icmp_ln89_1_reg_276;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & ((icmp_ln87_reg_255 == 1'd1) | (or_ln89_1_fu_238_p2 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        i_fu_68 <= 4'd0;
    end else if (((icmp_ln87_reg_255 == 1'd0) & (or_ln89_1_fu_238_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        i_fu_68 <= add_ln87_reg_259;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln87_reg_255 == 1'd0) & (or_ln89_1_fu_238_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        merge_reg_120 <= 1'd0;
...
assign add_ln87_fu_161_p2 = (ap_sig_allocacmp_i_1 + 4'd1);

assign and_ln89_fu_232_p2 = (or_ln89_fu_222_p2 & or_ln89_2_fu_226_p2);
...
assign grp_fu_508_p_din0 = p_x_assign_fu_167_p10;
