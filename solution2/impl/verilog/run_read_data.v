...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state73) & (icmp_ln523_reg_188 == 1'd0))) begin
            copying_preg <= 8'd0;
        end else if ((~((startCopy_ap_vld == 1'b0) | ((copyDest_full_n == 1'b0) & (icmp_ln523_fu_171_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state72) & (icmp_ln523_fu_171_p2 == 1'd0))) begin
            copying_preg <= 8'd255;
        end
    end
end
...
always @ (*) begin
    if (((startCopy_ap_vld == 1'b0) | ((copyDest_full_n == 1'b0) & (icmp_ln523_fu_171_p2 == 1'd0)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state72) & (icmp_ln523_fu_171_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((~((startCopy_ap_vld == 1'b0) | ((copyDest_full_n == 1'b0) & (icmp_ln523_fu_171_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state72) & (icmp_ln523_fu_171_p2 == 1'd0))) begin
        copyDest_write = 1'b1;
    end else begin
        copyDest_write = 1'b0;
    end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state73) & (icmp_ln523_reg_188 == 1'd0)) | (~((startCopy_ap_vld == 1'b0) | ((copyDest_full_n == 1'b0) & (icmp_ln523_fu_171_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state72) & (icmp_ln523_fu_171_p2 == 1'd0)))) begin
        copying_ap_vld = 1'b1;
    end else begin
        copying_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if ((~((startCopy_ap_vld == 1'b0) | ((copyDest_full_n == 1'b0) & (icmp_ln523_fu_171_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state72))) begin
...
always @ (*) begin
    ap_block_state72 = ((startCopy_ap_vld == 1'b0) | ((copyDest_full_n == 1'b0) & (icmp_ln523_fu_171_p2 == 1'd0)));
end
...
assign icmp_ln523_fu_171_p2 = ((startCopy == 8'd0) ? 1'b1 : 1'b0);
...
assign trunc_ln174_fu_157_p1 = m_axi_gmem_RDATA[23:0];
