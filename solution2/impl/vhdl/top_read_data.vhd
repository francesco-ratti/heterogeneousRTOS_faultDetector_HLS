...
architecture behav of top_read_data is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln526_reg_173 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln526_fu_114_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_s_reg_183 : STD_LOGIC_VECTOR (255 downto 0);
    signal tmp_47_reg_188 : STD_LOGIC_VECTOR (39 downto 0);
    signal trunc_ln174_fu_161_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal trunc_ln174_reg_193 : STD_LOGIC_VECTOR (23 downto 0);
    signal p_cast_cast_fu_130_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state2_io : BOOLEAN;
    signal ap_block_state1 : BOOLEAN;
    signal copying_preg : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    signal ap_block_state73 : BOOLEAN;
    signal p_cast_fu_120_p4 : STD_LOGIC_VECTOR (57 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then 
                    copying_preg <= ap_const_lv8_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem_RVALID = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                icmp_ln526_reg_173 <= icmp_ln526_fu_114_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state72)) then
                tmp_47_reg_188 <= m_axi_gmem_RDATA(71 downto 32);
                tmp_s_reg_183 <= m_axi_gmem_RDATA(351 downto 96);
                trunc_ln174_reg_193 <= trunc_ln174_fu_161_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, sourceStream_full_n, m_axi_gmem_RVALID, startCopy_ap_vld, ap_CS_fsm_state73, icmp_ln526_reg_173, ap_CS_fsm_state2, ap_CS_fsm_state72, ap_block_state2_io)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (startCopy_ap_vld = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln526_reg_173 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state73;
                elsif (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then
            ...
            when ap_ST_fsm_state73 => 
                if ((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state73;
                end if;
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(ap_start, ap_done_reg, startCopy_ap_vld)
    begin
        if (((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (startCopy_ap_vld = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state73_blk_assign_proc : process(sourceStream_full_n, icmp_ln526_reg_173)
    begin
        if (((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then 
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, startCopy_ap_vld)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (startCopy_ap_vld = ap_const_logic_0));
    end process;


    ap_block_state2_io_assign_proc : process(m_axi_gmem_ARREADY, icmp_ln526_reg_173)
    begin
                ap_block_state2_io <= ((icmp_ln526_reg_173 = ap_const_lv1_0) and (m_axi_gmem_ARREADY = ap_const_logic_0));
    end process;


    ap_block_state73_assign_proc : process(sourceStream_full_n, icmp_ln526_reg_173)
    begin
                ap_block_state73 <= ((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0));
    end process;


    ap_done_assign_proc : process(ap_done_reg, sourceStream_full_n, ap_CS_fsm_state73, icmp_ln526_reg_173)
    begin
        if ((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    ap_ready_assign_proc : process(sourceStream_full_n, ap_CS_fsm_state73, icmp_ln526_reg_173)
    begin
        if ((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    copying_assign_proc : process(sourceStream_full_n, m_axi_gmem_RVALID, ap_CS_fsm_state73, icmp_ln526_reg_173, ap_CS_fsm_state72, copying_preg)
    begin
        if ((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then 
    ...
    copying_ap_vld_assign_proc : process(sourceStream_full_n, m_axi_gmem_RVALID, ap_CS_fsm_state73, icmp_ln526_reg_173, ap_CS_fsm_state72)
    begin
        if (((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln526_reg_173 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem_RVALID = ap_const_logic_1)))) then 
    ...
    gmem_blk_n_AR_assign_proc : process(m_axi_gmem_ARREADY, icmp_ln526_reg_173, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then 
    ...
    icmp_ln526_fu_114_p2 <= "1" when (startCopy = ap_const_lv8_0) else "0";
    m_axi_gmem_ARADDR <= p_cast_cast_fu_130_p1;
    ...
    m_axi_gmem_ARVALID_assign_proc : process(icmp_ln526_reg_173, ap_CS_fsm_state2, ap_block_state2_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then 
    ...
    m_axi_gmem_WVALID <= ap_const_logic_0;
        p_cast_cast_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_cast_fu_120_p4),64));

    p_cast_fu_120_p4 <= inputAOV(63 downto 6);

    sourceStream_blk_n_assign_proc : process(sourceStream_full_n, ap_CS_fsm_state73, icmp_ln526_reg_173)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then 
    ...
    sourceStream_din <= ((tmp_s_reg_183 & tmp_47_reg_188) & trunc_ln174_reg_193);

    sourceStream_write_assign_proc : process(sourceStream_full_n, ap_CS_fsm_state73, icmp_ln526_reg_173)
    begin
        if ((not(((sourceStream_full_n = ap_const_logic_0) and (icmp_ln526_reg_173 = ap_const_lv1_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln526_reg_173 = ap_const_lv1_0))) then 
    ...
    startCopy_ap_ack_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, startCopy_ap_vld)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (startCopy_ap_vld = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    startCopy_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, startCopy_ap_vld)
    begin
    ...
    trunc_ln174_fu_161_p1 <= m_axi_gmem_RDATA(24 - 1 downto 0);
end behav;
