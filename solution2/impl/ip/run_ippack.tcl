...
set IPName      "run"
set Version     "1.0"
set DisplayName "faultDetectorMicro"
set Revision    "2112714970"
...
set xo_kernel_name "run"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/francesco/workspace/detector_solid/solution2"
set debug_dir "/home/francesco/workspace/detector_solid/solution2/.debug"
set xo_hls_files_dir ""
set hdl_module_list {run_fcmp_32ns_32ns_1_2_no_dsp_1
run_mux_84_32_1_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST R 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST R 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x20 inputAOV_1 W 0x0 "Data signal of inputAOV" {{0 32 inputAOV W 0 "Bit 31 to 0 of inputAOV"}}} {0x24 inputAOV_2 W 0x0 "Data signal of inputAOV" {{0 32 inputAOV W 0 "Bit 63 to 32 of inputAOV"}}} {0x2c accel_mode W 0x0 "Data signal of accel_mode" {{0 8 accel_mode W 0 "Bit 7 to 0 of accel_mode"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x34 trainedRegion_i_1 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 31 to 0 of trainedRegion_i"}}} {0x38 trainedRegion_i_2 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 63 to 32 of trainedRegion_i"}}} {0x3c trainedRegion_i_3 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 95 to 64 of trainedRegion_i"}}} {0x40 trainedRegion_i_4 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 127 to 96 of trainedRegion_i"}}} {0x44 trainedRegion_i_5 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 159 to 128 of trainedRegion_i"}}} {0x48 trainedRegion_i_6 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 191 to 160 of trainedRegion_i"}}} {0x4c trainedRegion_i_7 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 223 to 192 of trainedRegion_i"}}} {0x50 trainedRegion_i_8 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 255 to 224 of trainedRegion_i"}}} {0x54 trainedRegion_i_9 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 287 to 256 of trainedRegion_i"}}} {0x58 trainedRegion_i_10 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 319 to 288 of trainedRegion_i"}}} {0x5c trainedRegion_i_11 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 351 to 320 of trainedRegion_i"}}} {0x60 trainedRegion_i_12 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 383 to 352 of trainedRegion_i"}}} {0x64 trainedRegion_i_13 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 415 to 384 of trainedRegion_i"}}} {0x68 trainedRegion_i_14 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 447 to 416 of trainedRegion_i"}}} {0x6c trainedRegion_i_15 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 479 to 448 of trainedRegion_i"}}} {0x70 trainedRegion_i_16 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 511 to 480 of trainedRegion_i"}}} {0x74 trainedRegion_i_17 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 543 to 512 of trainedRegion_i"}}} {0x78 trainedRegion_i_18 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 575 to 544 of trainedRegion_i"}}} {0x7c trainedRegion_i_19 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 607 to 576 of trainedRegion_i"}}} {0x80 trainedRegion_i_20 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 639 to 608 of trainedRegion_i"}}} {0x84 trainedRegion_i_21 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 671 to 640 of trainedRegion_i"}}} {0x88 trainedRegion_i_22 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 703 to 672 of trainedRegion_i"}}} {0x8c trainedRegion_i_23 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 735 to 704 of trainedRegion_i"}}} {0x90 trainedRegion_i_24 W 0x0 "Data signal of trainedRegion_i" {{0 32 trainedRegion_i W 0 "Bit 767 to 736 of trainedRegion_i"}}} {0x98 trainedRegion_o_1 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 31 to 0 of trainedRegion_o"}}} {0x9c trainedRegion_o_2 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 63 to 32 of trainedRegion_o"}}} {0xa0 trainedRegion_o_3 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 95 to 64 of trainedRegion_o"}}} {0xa4 trainedRegion_o_4 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 127 to 96 of trainedRegion_o"}}} {0xa8 trainedRegion_o_5 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 159 to 128 of trainedRegion_o"}}} {0xac trainedRegion_o_6 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 191 to 160 of trainedRegion_o"}}} {0xb0 trainedRegion_o_7 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 223 to 192 of trainedRegion_o"}}} {0xb4 trainedRegion_o_8 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 255 to 224 of trainedRegion_o"}}} {0xb8 trainedRegion_o_9 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 287 to 256 of trainedRegion_o"}}} {0xbc trainedRegion_o_10 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 319 to 288 of trainedRegion_o"}}} {0xc0 trainedRegion_o_11 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 351 to 320 of trainedRegion_o"}}} {0xc4 trainedRegion_o_12 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 383 to 352 of trainedRegion_o"}}} {0xc8 trainedRegion_o_13 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 415 to 384 of trainedRegion_o"}}} {0xcc trainedRegion_o_14 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 447 to 416 of trainedRegion_o"}}} {0xd0 trainedRegion_o_15 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 479 to 448 of trainedRegion_o"}}} {0xd4 trainedRegion_o_16 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 511 to 480 of trainedRegion_o"}}} {0xd8 trainedRegion_o_17 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 543 to 512 of trainedRegion_o"}}} {0xdc trainedRegion_o_18 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 575 to 544 of trainedRegion_o"}}} {0xe0 trainedRegion_o_19 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 607 to 576 of trainedRegion_o"}}} {0xe4 trainedRegion_o_20 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 639 to 608 of trainedRegion_o"}}} {0xe8 trainedRegion_o_21 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 671 to 640 of trainedRegion_o"}}} {0xec trainedRegion_o_22 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 703 to 672 of trainedRegion_o"}}} {0xf0 trainedRegion_o_23 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 735 to 704 of trainedRegion_o"}}} {0xf4 trainedRegion_o_24 R 0x0 "Data signal of trainedRegion_o" {{0 32 trainedRegion_o R 0 "Bit 767 to 736 of trainedRegion_o"}}} {0x160 IOCheckIdx W 0x0 "Data signal of IOCheckIdx" {{0 8 IOCheckIdx W 0 "Bit 7 to 0 of IOCheckIdx"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x168 IORegionIdx W 0x0 "Data signal of IORegionIdx" {{0 8 IORegionIdx W 0 "Bit 7 to 0 of IORegionIdx"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x170 n_regions_in_i W 0x0 "Data signal of n_regions_in_i" {{0 8 n_regions_in_i W 0 "Bit 7 to 0 of n_regions_in_i"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x178 n_regions_in_o R 0x0 "Data signal of n_regions_in_o" {{0 8 n_regions_in_o R 0 "Bit 7 to 0 of n_regions_in_o"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "errorInTask {base_address 16 range 16} outcomeInRam {base_address 1024 range 1024}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 20 machine 64 combinational 0 latency 2 II x}
...
source -notrace "/home/francesco/tools/Xilinx/Vitis_HLS/2022.1/common/scripts/ipxhls.tcl"
