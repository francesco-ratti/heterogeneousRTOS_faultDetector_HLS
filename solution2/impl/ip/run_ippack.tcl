...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem toScheduler"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
