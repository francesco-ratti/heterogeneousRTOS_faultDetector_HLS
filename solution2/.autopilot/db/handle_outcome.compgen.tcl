...
set ID 168
set hasByteEnable 0
set MemName top_handle_outcome_in_AOV_RAM_AUTO_1R1W
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { failedTask { O 16 vector } failedTask_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { destStream_dout { I 297 vector } destStream_num_data_valid { I 2 vector } destStream_fifo_cap { I 2 vector } destStream_empty_n { I 1 bit } destStream_read { O 1 bit } } \
} "
}
