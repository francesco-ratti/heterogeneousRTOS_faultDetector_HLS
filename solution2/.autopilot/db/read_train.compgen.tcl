...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_copyInputAOV \
    op interface \
    ports { copyInputAOV { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { copyInputAOV_in_c_din { O 8 vector } copyInputAOV_in_c_num_data_valid { I 2 vector } copyInputAOV_in_c_fifo_cap { I 2 vector } copyInputAOV_in_c_full_n { I 1 bit } copyInputAOV_in_c_write { O 1 bit } } \
} "
}
