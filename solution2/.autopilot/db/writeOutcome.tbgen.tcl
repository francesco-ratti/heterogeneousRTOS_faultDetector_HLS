...
set C_modelArgList {
	...
	{ failedTaskExecutionId_read int 8 regular  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "failedTaskExecutionId_read", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "failedTaskExecutionId_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_writeOutcome_Pipeline_1_fu_315.mux_84_32_1_1_U170", "Parent" : "2"},
...
set Spec2ImplPortList { 
	...
	failedTaskExecutionId_read { ap_none {  { failedTaskExecutionId_read in_data 0 8 } } }
