...
set C_modelArgMapList {[ 
	{ "Name" : "tmp_187", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_187 sc_in sc_lv 12 signal 0 } 
	...
	{ d_read sc_in sc_lv 32 signal 7 } 
	{ d_read_8 sc_in sc_lv 32 signal 8 } 
	{ d_read_9 sc_in sc_lv 32 signal 9 } 
	{ d_read_10 sc_in sc_lv 32 signal 10 } 
	{ d_read_11 sc_in sc_lv 32 signal 11 } 
	{ d_read_12 sc_in sc_lv 32 signal 12 } 
	{ d_read_13 sc_in sc_lv 32 signal 13 } 
	{ d_read_14 sc_in sc_lv 32 signal 14 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_187", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "tmp_187", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_84_32_1_1_U14", "Parent" : "0"},
...
set Spec2ImplPortList { 
	tmp_187 { ap_none {  { tmp_187 in_data 0 12 } } }
