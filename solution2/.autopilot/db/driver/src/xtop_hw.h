...
#define XTOP_CONTROL_ADDR_AP_CTRL               0x000
#define XTOP_CONTROL_ADDR_GIE                   0x004
#define XTOP_CONTROL_ADDR_IER                   0x008
#define XTOP_CONTROL_ADDR_ISR                   0x00c
#define XTOP_CONTROL_ADDR_ACCEL_MODE_DATA       0x010
#define XTOP_CONTROL_BITS_ACCEL_MODE_DATA       8
#define XTOP_CONTROL_ADDR_COPYING_DATA          0x018
#define XTOP_CONTROL_BITS_COPYING_DATA          8
#define XTOP_CONTROL_ADDR_INPUTDATA_DATA        0x028
#define XTOP_CONTROL_BITS_INPUTDATA_DATA        64
#define XTOP_CONTROL_ADDR_STARTCOPY_DATA        0x034
#define XTOP_CONTROL_BITS_STARTCOPY_DATA        8
#define XTOP_CONTROL_ADDR_STARTCOPY_CTRL        0x038
#define XTOP_CONTROL_ADDR_TRAINEDREGION_I_DATA  0x050
#define XTOP_CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define XTOP_CONTROL_ADDR_TRAINEDREGION_I_DATA_ 0x078
#define XTOP_CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define XTOP_CONTROL_ADDR_TRAINEDREGION_O_DATA  0x0b4
#define XTOP_CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define XTOP_CONTROL_ADDR_TRAINEDREGION_O_DATA_ 0x0dc
#define XTOP_CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define XTOP_CONTROL_ADDR_IOCHECKIDX_DATA       0x17c
#define XTOP_CONTROL_BITS_IOCHECKIDX_DATA       8
#define XTOP_CONTROL_ADDR_IOREGIONIDX_DATA      0x184
#define XTOP_CONTROL_BITS_IOREGIONIDX_DATA      8
#define XTOP_CONTROL_ADDR_N_REGIONS_IN_I_DATA   0x18c
#define XTOP_CONTROL_BITS_N_REGIONS_IN_I_DATA   8
#define XTOP_CONTROL_ADDR_N_REGIONS_IN_O_DATA   0x194
#define XTOP_CONTROL_BITS_N_REGIONS_IN_O_DATA   8
#define XTOP_CONTROL_ADDR_FAILEDTASK_DATA       0x1a0
#define XTOP_CONTROL_BITS_FAILEDTASK_DATA       16
#define XTOP_CONTROL_ADDR_FAILEDTASK_CTRL       0x1a4
#define XTOP_CONTROL_ADDR_ERRORINTASK_BASE      0x040
#define XTOP_CONTROL_ADDR_ERRORINTASK_HIGH      0x04f
#define XTOP_CONTROL_WIDTH_ERRORINTASK          8
#define XTOP_CONTROL_DEPTH_ERRORINTASK          16
#define XTOP_CONTROL_ADDR_OUTCOMEINRAM_BASE     0x400
#define XTOP_CONTROL_ADDR_OUTCOMEINRAM_HIGH     0x7ff
#define XTOP_CONTROL_WIDTH_OUTCOMEINRAM         288
#define XTOP_CONTROL_DEPTH_OUTCOMEINRAM         16
