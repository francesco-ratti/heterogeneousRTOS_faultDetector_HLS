...
set C_modelArgMapList {[ 
	{ "Name" : "tmp_11", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_11 sc_in sc_lv 12 signal 0 } 
	{ regions_address0 sc_out sc_lv 12 signal 1 } 
	...
	{ trunc_ln1 sc_in sc_lv 1 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_11", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "tmp_11", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_864_32_1_1_U845", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U846", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U847", "Parent" : "0"},
...
set Spec2ImplPortList { 
	tmp_11 { ap_none {  { tmp_11 in_data 0 12 } } }
	...
	regions_4 { ap_memory {  { regions_4_address0 mem_address 1 12 }  { regions_4_ce0 mem_ce 1 1 }  { regions_4_q0 in_data 0 32 } } }
