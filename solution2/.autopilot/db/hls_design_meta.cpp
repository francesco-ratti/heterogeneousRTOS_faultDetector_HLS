...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("failedTask", 16, hls_out, 10, "ap_hs", "out_data", 1),
	Port_Property("failedTask_ap_vld", 1, hls_out, 10, "ap_hs", "out_vld", 1),
	Port_Property("failedTask_ap_ack", 1, hls_in, 10, "ap_hs", "out_acc", 1),
