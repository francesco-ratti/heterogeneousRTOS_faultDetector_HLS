...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename outcome_AOV \
    op interface \
    ports { outcome_AOV_address0 { O 3 vector } outcome_AOV_ce0 { O 1 bit } outcome_AOV_we0 { O 1 bit } outcome_AOV_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'outcome_AOV'"
}
}
