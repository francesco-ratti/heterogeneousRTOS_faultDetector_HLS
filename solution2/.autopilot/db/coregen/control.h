...
#define CONTROL_ADDR_INPUTAOV_DATA         0x020
#define CONTROL_BITS_INPUTAOV_DATA         64
#define CONTROL_ADDR_READYFORDATA_DATA     0x02c
#define CONTROL_BITS_READYFORDATA_DATA     8
#define CONTROL_ADDR_COPYINPUTAOV_DATA     0x034
#define CONTROL_BITS_COPYINPUTAOV_DATA     8
#define CONTROL_ADDR_ACCEL_MODE_DATA       0x03c
#define CONTROL_BITS_ACCEL_MODE_DATA       8
#define CONTROL_ADDR_TRAINEDREGION_I_DATA  0x044
#define CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define CONTROL_ADDR_TRAINEDREGION_I_DATA_ 0x06c
#define CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define CONTROL_ADDR_TRAINEDREGION_O_DATA  0x0a8
#define CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define CONTROL_ADDR_TRAINEDREGION_O_DATA_ 0x0d0
#define CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define CONTROL_ADDR_IOCHECKIDX_DATA       0x170
#define CONTROL_BITS_IOCHECKIDX_DATA       8
#define CONTROL_ADDR_IOREGIONIDX_DATA      0x178
#define CONTROL_BITS_IOREGIONIDX_DATA      8
#define CONTROL_ADDR_N_REGIONS_IN_I_DATA   0x180
#define CONTROL_BITS_N_REGIONS_IN_I_DATA   8
#define CONTROL_ADDR_N_REGIONS_IN_O_DATA   0x188
#define CONTROL_BITS_N_REGIONS_IN_O_DATA   8
#define CONTROL_ADDR_ERRORINTASK_BASE      0x010
#define CONTROL_ADDR_ERRORINTASK_HIGH      0x01f
#define CONTROL_WIDTH_ERRORINTASK          1
#define CONTROL_DEPTH_ERRORINTASK          16
#define CONTROL_ADDR_OUTCOMEINRAM_BASE     0x400
#define CONTROL_ADDR_OUTCOMEINRAM_HIGH     0x7ff
#define CONTROL_WIDTH_OUTCOMEINRAM         288
#define CONTROL_DEPTH_OUTCOMEINRAM         16
