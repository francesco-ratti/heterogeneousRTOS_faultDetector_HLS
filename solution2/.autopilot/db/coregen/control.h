...
#define CONTROL_ADDR_STARTCOPY_DATA        0x034
#define CONTROL_BITS_STARTCOPY_DATA        8
#define CONTROL_ADDR_STARTCOPY_CTRL        0x038
#define CONTROL_ADDR_TRAINEDREGION_I_DATA  0x050
#define CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define CONTROL_ADDR_TRAINEDREGION_I_DATA_ 0x078
#define CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define CONTROL_ADDR_TRAINEDREGION_O_DATA  0x0b4
#define CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define CONTROL_ADDR_TRAINEDREGION_O_DATA_ 0x0dc
#define CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define CONTROL_ADDR_IOCHECKIDX_DATA       0x17c
#define CONTROL_BITS_IOCHECKIDX_DATA       8
#define CONTROL_ADDR_IOREGIONIDX_DATA      0x184
#define CONTROL_BITS_IOREGIONIDX_DATA      8
#define CONTROL_ADDR_N_REGIONS_IN_I_DATA   0x18c
#define CONTROL_BITS_N_REGIONS_IN_I_DATA   8
#define CONTROL_ADDR_N_REGIONS_IN_O_DATA   0x194
#define CONTROL_BITS_N_REGIONS_IN_O_DATA   8
#define CONTROL_ADDR_FAILEDTASK_DATA       0x19c
#define CONTROL_BITS_FAILEDTASK_DATA       16
#define CONTROL_ADDR_FAILEDTASK_CTRL       0x1a0
