...
#define CONTROL_ADDR_T_BASE              0x00010
#define CONTROL_ADDR_T_HIGH              0x00017
#define CONTROL_WIDTH_T                  32
#define CONTROL_DEPTH_T                  2
#define CONTROL_ADDR_ERRORINTASK_BASE    0x00020
#define CONTROL_ADDR_ERRORINTASK_HIGH    0x0002f
#define CONTROL_WIDTH_ERRORINTASK        1
#define CONTROL_DEPTH_ERRORINTASK        16
#define CONTROL_ADDR_N_REGIONS_IN_BASE   0x00040
#define CONTROL_ADDR_N_REGIONS_IN_HIGH   0x0007f
#define CONTROL_WIDTH_N_REGIONS_IN       8
#define CONTROL_DEPTH_N_REGIONS_IN       64
#define CONTROL_ADDR_OUTCOMEINRAM_BASE   0x00400
#define CONTROL_ADDR_OUTCOMEINRAM_HIGH   0x007ff
#define CONTROL_WIDTH_OUTCOMEINRAM       288
#define CONTROL_DEPTH_OUTCOMEINRAM       16
#define CONTROL_ADDR_TRAINEDREGIONS_BASE 0x20000
#define CONTROL_ADDR_TRAINEDREGIONS_HIGH 0x3ffff
#define CONTROL_WIDTH_TRAINEDREGIONS     32
#define CONTROL_DEPTH_TRAINEDREGIONS     24576
