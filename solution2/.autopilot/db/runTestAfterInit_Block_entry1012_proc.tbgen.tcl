set moduleName runTestAfterInit_Block_entry1012_proc
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {runTestAfterInit_Block_entry1012_proc}
set C_modelType { int 26 }
set C_modelArgList {
	{ p_read int 8 regular  }
	{ n_regions_V int 8 regular {array 64 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "n_regions_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ n_regions_V_q0 sc_in sc_lv 8 signal 1 } 
