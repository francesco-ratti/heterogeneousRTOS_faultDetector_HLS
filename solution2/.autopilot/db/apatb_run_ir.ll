...
entry:
  ...
  call void @apatb_run_hw(i8* %2, %struct.OutcomeStr* %3, %struct.controlStr* %inputAOV_copy, i8 %accel_mode, %struct.REGION_T* %trainedRegion_i, %struct.REGION_T* %trainedRegion_o_copy, %"struct.ap_uint<8>"* %IOCheckIdx, %"struct.ap_uint<8>"* %IORegionIdx, %"struct.ap_uint<8>"* %n_regions_in_copy, i16* %failedTask_copy)
  call void @copy_back([16 x i8]* %0, [16 x i8]* %errorInTask_copy, [16 x %struct.OutcomeStr]* %1, [16 x %struct.OutcomeStr]* %outcomeInRam_copy, %struct.controlStr* %inputAOV, %struct.controlStr* %inputAOV_copy, %struct.REGION_T* %trainedRegion_o, %struct.REGION_T* %trainedRegion_o_copy, %"struct.ap_uint<8>"* %n_regions_in, %"struct.ap_uint<8>"* %n_regions_in_copy, %struct.taskFailure* %failedTask, i16* %failedTask_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_in([16 x i8]* noalias readonly, [16 x i8]* noalias align 512, [16 x %struct.OutcomeStr]* noalias readonly, [16 x %struct.OutcomeStr]* noalias align 512, %struct.controlStr* noalias readonly, %struct.controlStr* noalias align 512, %struct.REGION_T* noalias readonly, %struct.REGION_T* noalias align 512, %"struct.ap_uint<8>"* noalias readonly, %"struct.ap_uint<8>"* noalias align 512, %struct.taskFailure* noalias readonly, i16* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0struct.taskFailure(i16* align 512 %11, %struct.taskFailure* %10)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([16 x i8]* noalias, [16 x i8]* noalias readonly align 512, [16 x %struct.OutcomeStr]* noalias, [16 x %struct.OutcomeStr]* noalias readonly align 512, %struct.controlStr* noalias, %struct.controlStr* noalias readonly align 512, %struct.REGION_T* noalias, %struct.REGION_T* noalias readonly align 512, %"struct.ap_uint<8>"* noalias, %"struct.ap_uint<8>"* noalias readonly align 512, %struct.taskFailure* noalias, i16* noalias readonly align 512) unnamed_addr #3 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0struct.taskFailure.59(%struct.taskFailure* %10, i16* align 512 %11)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0struct.taskFailure.59(%struct.taskFailure* noalias, i16* noalias readonly align 512) unnamed_addr #2 {
entry:
...
declare void @apatb_run_hw(i8*, %struct.OutcomeStr*, %struct.controlStr*, i8, %struct.REGION_T*, %struct.REGION_T*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, i16*)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([16 x i8]* noalias, [16 x i8]* noalias readonly align 512, [16 x %struct.OutcomeStr]* noalias, [16 x %struct.OutcomeStr]* noalias readonly align 512, %struct.controlStr* noalias, %struct.controlStr* noalias readonly align 512, %struct.REGION_T* noalias, %struct.REGION_T* noalias readonly align 512, %"struct.ap_uint<8>"* noalias, %"struct.ap_uint<8>"* noalias readonly align 512, %struct.taskFailure* noalias, i16* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a16i8([16 x i8]* %0, [16 x i8]* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a16struct.OutcomeStr([16 x %struct.OutcomeStr]* %2, [16 x %struct.OutcomeStr]* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0struct.REGION_T(%struct.REGION_T* %6, %struct.REGION_T* align 512 %7)
...
define void @run_hw_stub_wrapper(i8*, %struct.OutcomeStr*, %struct.controlStr*, i8, %struct.REGION_T*, %struct.REGION_T*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, i16*) #4 {
entry:
  %10 = alloca %struct.taskFailure
  %11 = bitcast i8* %0 to [16 x i8]*
  %12 = bitcast %struct.OutcomeStr* %1 to [16 x %struct.OutcomeStr]*
  call void @copy_out([16 x i8]* null, [16 x i8]* %11, [16 x %struct.OutcomeStr]* null, [16 x %struct.OutcomeStr]* %12, %struct.controlStr* null, %struct.controlStr* %2, %struct.REGION_T* null, %struct.REGION_T* %5, %"struct.ap_uint<8>"* null, %"struct.ap_uint<8>"* %8, %struct.taskFailure* %10, i16* %9)
  %13 = bitcast [16 x i8]* %11 to i8*
  %14 = bitcast [16 x %struct.OutcomeStr]* %12 to %struct.OutcomeStr*
  call void @run_hw_stub(i8* %13, %struct.OutcomeStr* %14, %struct.controlStr* %2, i8 %3, %struct.REGION_T* %4, %struct.REGION_T* %5, %"struct.ap_uint<8>"* %6, %"struct.ap_uint<8>"* %7, %"struct.ap_uint<8>"* %8, %struct.taskFailure* %10)
  call void @copy_in([16 x i8]* null, [16 x i8]* %11, [16 x %struct.OutcomeStr]* null, [16 x %struct.OutcomeStr]* %12, %struct.controlStr* null, %struct.controlStr* %2, %struct.REGION_T* null, %struct.REGION_T* %5, %"struct.ap_uint<8>"* null, %"struct.ap_uint<8>"* %8, %struct.taskFailure* %10, i16* %9)
  ret void
}

declare void @run_hw_stub(i8*, %struct.OutcomeStr*, %struct.controlStr*, i8, %struct.REGION_T*, %struct.REGION_T*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %"struct.ap_uint<8>"*, %struct.taskFailure*)
