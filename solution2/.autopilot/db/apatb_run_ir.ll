...
define void @apatb_run_ir(i8 signext %accel_mode, i8* noalias nocapture nonnull %copying, %struct.controlStr* noalias nocapture nonnull readonly %inputData, i8* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" %errorInTask, %struct.OutcomeStr* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" %outcomeInRam, %struct.REGION_T* nocapture readonly %trainedRegion_i, %struct.REGION_T* noalias nocapture nonnull %trainedRegion_o, %"struct.ap_uint<8>"* nocapture readonly %IOCheckIdx, %"struct.ap_uint<8>"* nocapture readonly %IORegionIdx, %"struct.ap_uint<8>"* noalias nocapture nonnull %n_regions_in, %struct.taskFailure* noalias nocapture nonnull %failedTask) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_run_hw(i8 %accel_mode, i8* %copying_copy, %struct.controlStr* %inputData_copy, i8* %2, %struct.OutcomeStr* %3, %struct.REGION_T* %trainedRegion_i, %struct.REGION_T* %trainedRegion_o_copy, %"struct.ap_uint<8>"* %IOCheckIdx, %"struct.ap_uint<8>"* %IORegionIdx, %"struct.ap_uint<8>"* %n_regions_in_copy, i16* %failedTask_copy)
  call void @copy_back(i8* %copying, i8* %copying_copy, %struct.controlStr* %inputData, %struct.controlStr* %inputData_copy, [16 x i8]* %0, [16 x i8]* %errorInTask_copy, [16 x %struct.OutcomeStr]* %1, [16 x %struct.OutcomeStr]* %outcomeInRam_copy, %struct.REGION_T* %trainedRegion_o, %struct.REGION_T* %trainedRegion_o_copy, %"struct.ap_uint<8>"* %n_regions_in, %"struct.ap_uint<8>"* %n_regions_in_copy, %struct.taskFailure* %failedTask, i16* %failedTask_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_in(i8* noalias readonly, i8* noalias align 512, %struct.controlStr* noalias readonly, %struct.controlStr* noalias align 512, [16 x i8]* noalias readonly, [16 x i8]* noalias align 512, [16 x %struct.OutcomeStr]* noalias readonly, [16 x %struct.OutcomeStr]* noalias align 512, %struct.REGION_T* noalias readonly, %struct.REGION_T* noalias align 512, %"struct.ap_uint<8>"* noalias readonly, %"struct.ap_uint<8>"* noalias align 512, %struct.taskFailure* noalias readonly, i16* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a16struct.OutcomeStr([16 x %struct.OutcomeStr]* align 512 %7, [16 x %struct.OutcomeStr]* %6)
  call fastcc void @onebyonecpy_hls.p0struct.REGION_T(%struct.REGION_T* align 512 %9, %struct.REGION_T* %8)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<8>"(%"struct.ap_uint<8>"* align 512 %11, %"struct.ap_uint<8>"* %10)
  call fastcc void @onebyonecpy_hls.p0struct.taskFailure(i16* align 512 %13, %struct.taskFailure* %12)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out(i8* noalias, i8* noalias readonly align 512, %struct.controlStr* noalias, %struct.controlStr* noalias readonly align 512, [16 x i8]* noalias, [16 x i8]* noalias readonly align 512, [16 x %struct.OutcomeStr]* noalias, [16 x %struct.OutcomeStr]* noalias readonly align 512, %struct.REGION_T* noalias, %struct.REGION_T* noalias readonly align 512, %"struct.ap_uint<8>"* noalias, %"struct.ap_uint<8>"* noalias readonly align 512, %struct.taskFailure* noalias, i16* noalias readonly align 512) unnamed_addr #3 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a16struct.OutcomeStr([16 x %struct.OutcomeStr]* %6, [16 x %struct.OutcomeStr]* align 512 %7)
  call fastcc void @onebyonecpy_hls.p0struct.REGION_T(%struct.REGION_T* %8, %struct.REGION_T* align 512 %9)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<8>"(%"struct.ap_uint<8>"* %10, %"struct.ap_uint<8>"* align 512 %11)
  call fastcc void @onebyonecpy_hls.p0struct.taskFailure.112(%struct.taskFailure* %12, i16* align 512 %13)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0struct.taskFailure.112(%struct.taskFailure* noalias, i16* noalias readonly align 512) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back(i8* noalias, i8* noalias readonly align 512, %struct.controlStr* noalias, %struct.controlStr* noalias readonly align 512, [16 x i8]* noalias, [16 x i8]* noalias readonly align 512, [16 x %struct.OutcomeStr]* noalias, [16 x %struct.OutcomeStr]* noalias readonly align 512, %struct.REGION_T* noalias, %struct.REGION_T* noalias readonly align 512, %"struct.ap_uint<8>"* noalias, %"struct.ap_uint<8>"* noalias readonly align 512, %struct.taskFailure* noalias, i16* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0i8(i8* %0, i8* align 512 %1)
  call fastcc void @onebyonecpy_hls.p0a16i8([16 x i8]* %4, [16 x i8]* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0a16struct.OutcomeStr([16 x %struct.OutcomeStr]* %6, [16 x %struct.OutcomeStr]* align 512 %7)
...
entry:
  ...
  call void @copy_out(i8* null, i8* %1, %struct.controlStr* null, %struct.controlStr* %2, [16 x i8]* null, [16 x i8]* %12, [16 x %struct.OutcomeStr]* null, [16 x %struct.OutcomeStr]* %13, %struct.REGION_T* null, %struct.REGION_T* %6, %"struct.ap_uint<8>"* null, %"struct.ap_uint<8>"* %9, %struct.taskFailure* %11, i16* %10)
  ...
  call void @copy_in(i8* null, i8* %1, %struct.controlStr* null, %struct.controlStr* %2, [16 x i8]* null, [16 x i8]* %12, [16 x %struct.OutcomeStr]* null, [16 x %struct.OutcomeStr]* %13, %struct.REGION_T* null, %struct.REGION_T* %6, %"struct.ap_uint<8>"* null, %"struct.ap_uint<8>"* %9, %struct.taskFailure* %11, i16* %10)
  ret void
}
