...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0struct.taskFailure.417(%struct.taskFailure* %14, i16* align 512 %15)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0struct.taskFailure.417(%struct.taskFailure* noalias, i16* noalias readonly align 512) unnamed_addr #2 {
entry:
