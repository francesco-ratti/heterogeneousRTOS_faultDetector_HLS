set moduleName run_Pipeline_VITIS_LOOP_64_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {run_Pipeline_VITIS_LOOP_64_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ sext_ln64 int 16 regular  }
	{ idx_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln64", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln64 sc_in sc_lv 16 signal 0 } 
	{ idx_out sc_out sc_lv 32 signal 1 } 
	{ idx_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln64", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sext_ln64", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U6", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln64 { ap_none {  { sext_ln64 in_data 0 16 } } }
