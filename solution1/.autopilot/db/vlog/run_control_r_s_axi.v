...
localparam
    ...
    ADDR_IER                   = 6'h08,
    ADDR_ISR                   = 6'h0c,
    ADDR_TRAINEDREGIONS_DATA_0 = 6'h10,
    ADDR_TRAINEDREGIONS_DATA_1 = 6'h14,
    ADDR_TRAINEDREGIONS_CTRL   = 6'h18,
    ADDR_REALTASKID_DATA_0     = 6'h1c,
    ADDR_REALTASKID_DATA_1     = 6'h20,
    ADDR_REALTASKID_CTRL       = 6'h24,
    ADDR_N_REGIONS_IN_DATA_0   = 6'h28,
    ADDR_N_REGIONS_IN_DATA_1   = 6'h2c,
    ADDR_N_REGIONS_IN_CTRL     = 6'h30,
    ADDR_SHAREDMEM_DATA_0      = 6'h34,
    ADDR_SHAREDMEM_DATA_1      = 6'h38,
    ADDR_SHAREDMEM_CTRL        = 6'h3c,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
