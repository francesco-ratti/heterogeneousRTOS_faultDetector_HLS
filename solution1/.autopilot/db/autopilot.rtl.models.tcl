set SynModuleInfo {
  ...
  {SRCNAME runAfterInit MODELNAME runAfterInit RTLNAME run_runAfterInit
    SUBMODULES {
      {MODELNAME run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore RTLNAME run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME run_runAfterInit_data_0_RAM_AUTO_1R1W RTLNAME run_runAfterInit_data_0_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2}
      {MODELNAME run_fifo_w64_d16_S RTLNAME run_fifo_w64_d16_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      ...
      {MODELNAME run_fifo_w16_d6_S RTLNAME run_fifo_w16_d6_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
