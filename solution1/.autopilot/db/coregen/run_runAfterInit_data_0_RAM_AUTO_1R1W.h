...
#ifndef _run_runAfterInit_data_0_RAM_AUTO_1R1W_H_
#define _run_runAfterInit_data_0_RAM_AUTO_1R1W_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore.h"

SC_MODULE(run_runAfterInit_data_0_RAM_AUTO_1R1W) {
...
protected:
    ...
    run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore* run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U;
...
public:
    ~run_runAfterInit_data_0_RAM_AUTO_1R1W();
    SC_CTOR(run_runAfterInit_data_0_RAM_AUTO_1R1W) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U = new run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore("run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U");
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->clk      ( clk );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->reset    ( reset );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->ce0      ( i_ce0 );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->we0      ( i_we0 );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->address0 ( memcore_iaddr );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->d0       ( i_d0 );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->q0       ( i_q0 );

        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->ce1      ( t_ce0 );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->we1      ( t_we0 );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->address1 ( memcore_taddr );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->d1       ( t_d0 );
        run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "run_runAfterInit_data_0_RAM_AUTO_1R1W.trace");
            // ports
