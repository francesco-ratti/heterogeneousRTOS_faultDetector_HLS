...
#define CONTROL_ADDR_REALCHECKID_BASE    0x00040
#define CONTROL_ADDR_REALCHECKID_HIGH    0x0007f
#define CONTROL_WIDTH_REALCHECKID        8
#define CONTROL_DEPTH_REALCHECKID        64
#define CONTROL_ADDR_N_REGIONS_IN_BASE   0x00080
#define CONTROL_ADDR_N_REGIONS_IN_HIGH   0x000bf
