...
module run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore
#(parameter
    DataWidth    = 32,
    AddressWidth = 8,
    AddressRange = 256
...
reg  [0:0]              sel1_sr;
//------------------------Instantiation------------------
run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_ram #(
    .DataWidth(DataWidth),
    .AddressWidth(AddressWidth),
    .AddressRange(AddressRange))
run_runAfterInit_data_0_RAM_AUTO_1R1W_memcore_ram_u(
    .clk      ( clk ),
    .reset    ( reset ),
    .ce0      ( ce0 ),
    .address0 ( address0 ),
