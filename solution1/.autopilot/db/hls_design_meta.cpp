...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("toScheduler_TDATA", 8, hls_in, 6, "axis", "in_data", 1),
	Port_Property("toScheduler_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("toScheduler_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
