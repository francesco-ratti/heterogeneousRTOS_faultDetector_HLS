...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("control_TDATA", 32, hls_in, 1, "axis", "in_data", 1),
	Port_Property("toScheduler_TDATA", 8, hls_out, 6, "axis", "out_data", 1),
	Port_Property("control_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("control_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
