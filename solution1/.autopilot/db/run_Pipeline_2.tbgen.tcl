...
set hasInterrupt 0
set C_modelName {run_Pipeline_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem_load int 256 regular  }
	{ zext_ln587 int 7 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem_load", "interface" : "wire", "bitwidth" : 256, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln587", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ gmem_load sc_in sc_lv 256 signal 0 } 
	{ zext_ln587 sc_in sc_lv 7 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gmem_load", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "gmem_load", "role": "default" }} , 
 	{ "name": "zext_ln587", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "zext_ln587", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_0_U", "Parent" : "0"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_4_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_5_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_6_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.data_7_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	gmem_load { ap_none {  { gmem_load in_data 0 256 } } }
	zext_ln587 { ap_none {  { zext_ln587 in_data 0 7 } } }
}
