set moduleName writeOutcomeInRam
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {writeOutcomeInRam}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 256 regular {axi_master 1}  }
	{ outcomeptr int 64 regular  }
	{ outcome uint 1 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "sharedMem","offset": { "type": "dynamic","port_name": "sharedMem","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "outcomeptr", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "outcome", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ outcomeptr sc_in sc_lv 64 signal 1 } 
	{ outcome sc_in sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outcomeptr", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "outcomeptr", "role": "default" }} , 
 	{ "name": "outcome", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outcome", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	outcomeptr { ap_none {  { outcomeptr in_data 0 64 } } }
	outcome { ap_none {  { outcome in_data 0 1 } } }
}
