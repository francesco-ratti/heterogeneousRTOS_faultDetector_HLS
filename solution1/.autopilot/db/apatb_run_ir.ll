...
entry:
  ...
  call void @apatb_run_hw(%struct.controlStr* %contr, [16 x %struct.REGION_T]* %4, %"struct.ap_int<8>"* %5, %"struct.ap_int<16>"* %6, %"struct.ap_int<32>"* %7, %"class.hls::stream<ap_int<8>, 0>"* %toScheduler_copy)
  call void @copy_back([128 x [16 x %struct.REGION_T]]* %0, [128 x [16 x %struct.REGION_T]]* %trainedRegions_copy, [128 x %"struct.ap_int<8>"]* %1, [128 x %"struct.ap_int<8>"]* %realTaskId_copy, [128 x %"struct.ap_int<16>"]* %2, [128 x %"struct.ap_int<16>"]* %n_regions_in_copy, [4104 x %"struct.ap_int<32>"]* %3, [4104 x %"struct.ap_int<32>"]* %sharedMem_copy, %"class.hls::stream<ap_int<8>, 0>"* %toScheduler, %"class.hls::stream<ap_int<8>, 0>"* %toScheduler_copy)
...
declare void @apatb_run_hw(%struct.controlStr*, [16 x %struct.REGION_T]*, %"struct.ap_int<8>"*, %"struct.ap_int<16>"*, %"struct.ap_int<32>"*, %"class.hls::stream<ap_int<8>, 0>"*)
...
define void @run_hw_stub_wrapper(%struct.controlStr*, [16 x %struct.REGION_T]*, %"struct.ap_int<8>"*, %"struct.ap_int<16>"*, %"struct.ap_int<32>"*, %"class.hls::stream<ap_int<8>, 0>"*) #7 {
entry:
  ...
  call void @copy_out([128 x [16 x %struct.REGION_T]]* null, [128 x [16 x %struct.REGION_T]]* %6, [128 x %"struct.ap_int<8>"]* null, [128 x %"struct.ap_int<8>"]* %7, [128 x %"struct.ap_int<16>"]* null, [128 x %"struct.ap_int<16>"]* %8, [4104 x %"struct.ap_int<32>"]* null, [4104 x %"struct.ap_int<32>"]* %9, %"class.hls::stream<ap_int<8>, 0>"* null, %"class.hls::stream<ap_int<8>, 0>"* %5)
  ...
  call void @run_hw_stub(%struct.controlStr* %0, [16 x %struct.REGION_T]* %10, %"struct.ap_int<8>"* %11, %"struct.ap_int<16>"* %12, %"struct.ap_int<32>"* %13, %"class.hls::stream<ap_int<8>, 0>"* %5)
  call void @copy_in([128 x [16 x %struct.REGION_T]]* null, [128 x [16 x %struct.REGION_T]]* %6, [128 x %"struct.ap_int<8>"]* null, [128 x %"struct.ap_int<8>"]* %7, [128 x %"struct.ap_int<16>"]* null, [128 x %"struct.ap_int<16>"]* %8, [4104 x %"struct.ap_int<32>"]* null, [4104 x %"struct.ap_int<32>"]* %9, %"class.hls::stream<ap_int<8>, 0>"* null, %"class.hls::stream<ap_int<8>, 0>"* %5)
  ret void
}
