; ModuleID = 'C:/Users/franc/OneDrive/Documenti/detector_solid/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @llvm.sideeffect() #0 [ "stream_interface"(%"class.hls::stream<ap_int<8>, 0>"* %toScheduler_copy) ]
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %5 = getelementptr [128 x i8], [128 x i8]* %0, i64 0, i64 %for.loop.idx7
...
for.loop:                                         ; preds = %for.loop, %copy
  %for.loop.idx7 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop ]
  %5 = getelementptr [128 x i8], [128 x i8]* %1, i64 0, i64 %for.loop.idx7
