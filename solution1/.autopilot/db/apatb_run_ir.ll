...
define void @apatb_run_ir(%struct.controlStr* nocapture readonly %contr, [16 x %struct.REGION_T]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="128" %trainedRegions, %"struct.ap_int<16>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="128" %realTaskId, %"struct.ap_int<16>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="128" %n_regions_in, %"struct.ap_int<32>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="4104" %sharedMem, %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture nonnull dereferenceable(2) %toScheduler) local_unnamed_addr #1 {
entry:
  %malloccall = tail call i8* @malloc(i64 196608)
  %trainedRegions_copy = bitcast i8* %malloccall to [128 x [16 x %struct.REGION_T]]*
  %realTaskId_copy = alloca [128 x %"struct.ap_int<16>"], align 512
  %n_regions_in_copy = alloca [128 x %"struct.ap_int<16>"], align 512
  %malloccall1 = tail call i8* @malloc(i64 16416)
  %sharedMem_copy = bitcast i8* %malloccall1 to [4104 x %"struct.ap_int<32>"]*
  %toScheduler_copy = alloca %"class.hls::stream<ap_int<16>, 0>", align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(%"class.hls::stream<ap_int<16>, 0>"* %toScheduler_copy, i32 0) ]
  %0 = bitcast [16 x %struct.REGION_T]* %trainedRegions to [128 x [16 x %struct.REGION_T]]*
  %1 = bitcast %"struct.ap_int<16>"* %realTaskId to [128 x %"struct.ap_int<16>"]*
  ...
  call fastcc void @copy_in([128 x [16 x %struct.REGION_T]]* nonnull %0, [128 x [16 x %struct.REGION_T]]* %trainedRegions_copy, [128 x %"struct.ap_int<16>"]* nonnull %1, [128 x %"struct.ap_int<16>"]* nonnull align 512 %realTaskId_copy, [128 x %"struct.ap_int<16>"]* nonnull %2, [128 x %"struct.ap_int<16>"]* nonnull align 512 %n_regions_in_copy, [4104 x %"struct.ap_int<32>"]* nonnull %3, [4104 x %"struct.ap_int<32>"]* %sharedMem_copy, %"class.hls::stream<ap_int<16>, 0>"* nonnull %toScheduler, %"class.hls::stream<ap_int<16>, 0>"* nonnull align 512 %toScheduler_copy)
  %4 = getelementptr inbounds [128 x [16 x %struct.REGION_T]], [128 x [16 x %struct.REGION_T]]* %trainedRegions_copy, i32 0, i32 0
  %5 = getelementptr inbounds [128 x %"struct.ap_int<16>"], [128 x %"struct.ap_int<16>"]* %realTaskId_copy, i32 0, i32 0
  ...
  call void @apatb_run_hw(%struct.controlStr* %contr, [16 x %struct.REGION_T]* %4, %"struct.ap_int<16>"* %5, %"struct.ap_int<16>"* %6, %"struct.ap_int<32>"* %7, %"class.hls::stream<ap_int<16>, 0>"* %toScheduler_copy)
  call void @copy_back([128 x [16 x %struct.REGION_T]]* %0, [128 x [16 x %struct.REGION_T]]* %trainedRegions_copy, [128 x %"struct.ap_int<16>"]* %1, [128 x %"struct.ap_int<16>"]* %realTaskId_copy, [128 x %"struct.ap_int<16>"]* %2, [128 x %"struct.ap_int<16>"]* %n_regions_in_copy, [4104 x %"struct.ap_int<32>"]* %3, [4104 x %"struct.ap_int<32>"]* %sharedMem_copy, %"class.hls::stream<ap_int<16>, 0>"* %toScheduler, %"class.hls::stream<ap_int<16>, 0>"* %toScheduler_copy)
...
define internal fastcc void @copy_in([128 x [16 x %struct.REGION_T]]* noalias readonly, [128 x [16 x %struct.REGION_T]]* noalias, [128 x %"struct.ap_int<16>"]* noalias readonly, [128 x %"struct.ap_int<16>"]* noalias align 512, [128 x %"struct.ap_int<16>"]* noalias readonly, [128 x %"struct.ap_int<16>"]* noalias align 512, [4104 x %"struct.ap_int<32>"]* noalias readonly, [4104 x %"struct.ap_int<32>"]* noalias, %"class.hls::stream<ap_int<16>, 0>"* noalias, %"class.hls::stream<ap_int<16>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
  call fastcc void @onebyonecpy_hls.p0a128a16struct.REGION_T([128 x [16 x %struct.REGION_T]]* %1, [128 x [16 x %struct.REGION_T]]* %0)
  call fastcc void @"onebyonecpy_hls.p0a128struct.ap_int<16>"([128 x %"struct.ap_int<16>"]* align 512 %3, [128 x %"struct.ap_int<16>"]* %2)
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>"(%"class.hls::stream<ap_int<16>, 0>"* align 512 %9, %"class.hls::stream<ap_int<16>, 0>"* %8)
  ret void
}
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %src.addr.0.0.05 = getelementptr [128 x %"struct.ap_int<16>"], [128 x %"struct.ap_int<16>"]* %1, i64 0, i64 %for.loop.idx7, i32 0, i32 0, i32 0
  %dst.addr.0.0.06 = getelementptr [128 x %"struct.ap_int<16>"], [128 x %"struct.ap_int<16>"]* %0, i64 0, i64 %for.loop.idx7, i32 0, i32 0, i32 0
  %5 = load i16, i16* %src.addr.0.0.05, align 2
  store i16 %5, i16* %dst.addr.0.0.06, align 2
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>"(%"class.hls::stream<ap_int<16>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_int<16>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_int<16>, 0>"(%"class.hls::stream<ap_int<16>, 0>"* noalias nocapture align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_int<16>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([128 x [16 x %struct.REGION_T]]* noalias, [128 x [16 x %struct.REGION_T]]* noalias readonly, [128 x %"struct.ap_int<16>"]* noalias, [128 x %"struct.ap_int<16>"]* noalias readonly align 512, [128 x %"struct.ap_int<16>"]* noalias, [128 x %"struct.ap_int<16>"]* noalias readonly align 512, [4104 x %"struct.ap_int<32>"]* noalias, [4104 x %"struct.ap_int<32>"]* noalias readonly, %"class.hls::stream<ap_int<16>, 0>"* noalias, %"class.hls::stream<ap_int<16>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #6 {
entry:
  call fastcc void @onebyonecpy_hls.p0a128a16struct.REGION_T([128 x [16 x %struct.REGION_T]]* %0, [128 x [16 x %struct.REGION_T]]* %1)
  call fastcc void @"onebyonecpy_hls.p0a128struct.ap_int<16>"([128 x %"struct.ap_int<16>"]* %2, [128 x %"struct.ap_int<16>"]* align 512 %3)
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>"(%"class.hls::stream<ap_int<16>, 0>"* %8, %"class.hls::stream<ap_int<16>, 0>"* align 512 %9)
  ret void
}

declare void @free(i8*) local_unnamed_addr

declare void @apatb_run_hw(%struct.controlStr*, [16 x %struct.REGION_T]*, %"struct.ap_int<16>"*, %"struct.ap_int<16>"*, %"struct.ap_int<32>"*, %"class.hls::stream<ap_int<16>, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back([128 x [16 x %struct.REGION_T]]* noalias, [128 x [16 x %struct.REGION_T]]* noalias readonly, [128 x %"struct.ap_int<16>"]* noalias, [128 x %"struct.ap_int<16>"]* noalias readonly align 512, [128 x %"struct.ap_int<16>"]* noalias, [128 x %"struct.ap_int<16>"]* noalias readonly align 512, [4104 x %"struct.ap_int<32>"]* noalias, [4104 x %"struct.ap_int<32>"]* noalias readonly, %"class.hls::stream<ap_int<16>, 0>"* noalias, %"class.hls::stream<ap_int<16>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #6 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a4104struct.ap_int<32>"([4104 x %"struct.ap_int<32>"]* %6, [4104 x %"struct.ap_int<32>"]* %7)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_int<16>, 0>"(%"class.hls::stream<ap_int<16>, 0>"* %8, %"class.hls::stream<ap_int<16>, 0>"* align 512 %9)
  ret void
...
define void @run_hw_stub_wrapper(%struct.controlStr*, [16 x %struct.REGION_T]*, %"struct.ap_int<16>"*, %"struct.ap_int<16>"*, %"struct.ap_int<32>"*, %"class.hls::stream<ap_int<16>, 0>"*) #7 {
entry:
  %6 = bitcast [16 x %struct.REGION_T]* %1 to [128 x [16 x %struct.REGION_T]]*
  %7 = bitcast %"struct.ap_int<16>"* %2 to [128 x %"struct.ap_int<16>"]*
  %8 = bitcast %"struct.ap_int<16>"* %3 to [128 x %"struct.ap_int<16>"]*
  %9 = bitcast %"struct.ap_int<32>"* %4 to [4104 x %"struct.ap_int<32>"]*
  call void @copy_out([128 x [16 x %struct.REGION_T]]* null, [128 x [16 x %struct.REGION_T]]* %6, [128 x %"struct.ap_int<16>"]* null, [128 x %"struct.ap_int<16>"]* %7, [128 x %"struct.ap_int<16>"]* null, [128 x %"struct.ap_int<16>"]* %8, [4104 x %"struct.ap_int<32>"]* null, [4104 x %"struct.ap_int<32>"]* %9, %"class.hls::stream<ap_int<16>, 0>"* null, %"class.hls::stream<ap_int<16>, 0>"* %5)
  %10 = bitcast [128 x [16 x %struct.REGION_T]]* %6 to [16 x %struct.REGION_T]*
  %11 = bitcast [128 x %"struct.ap_int<16>"]* %7 to %"struct.ap_int<16>"*
  %12 = bitcast [128 x %"struct.ap_int<16>"]* %8 to %"struct.ap_int<16>"*
  %13 = bitcast [4104 x %"struct.ap_int<32>"]* %9 to %"struct.ap_int<32>"*
  call void @run_hw_stub(%struct.controlStr* %0, [16 x %struct.REGION_T]* %10, %"struct.ap_int<16>"* %11, %"struct.ap_int<16>"* %12, %"struct.ap_int<32>"* %13, %"class.hls::stream<ap_int<16>, 0>"* %5)
  call void @copy_in([128 x [16 x %struct.REGION_T]]* null, [128 x [16 x %struct.REGION_T]]* %6, [128 x %"struct.ap_int<16>"]* null, [128 x %"struct.ap_int<16>"]* %7, [128 x %"struct.ap_int<16>"]* null, [128 x %"struct.ap_int<16>"]* %8, [4104 x %"struct.ap_int<32>"]* null, [4104 x %"struct.ap_int<32>"]* %9, %"class.hls::stream<ap_int<16>, 0>"* null, %"class.hls::stream<ap_int<16>, 0>"* %5)
  ret void
}

declare void @run_hw_stub(%struct.controlStr*, [16 x %struct.REGION_T]*, %"struct.ap_int<16>"*, %"struct.ap_int<16>"*, %"struct.ap_int<32>"*, %"class.hls::stream<ap_int<16>, 0>"*)
