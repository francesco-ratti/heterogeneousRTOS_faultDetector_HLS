...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outcomeInRam_dout { I 64 vector } outcomeInRam_num_data_valid { I 6 vector } outcomeInRam_fifo_cap { I 6 vector } outcomeInRam_empty_n { I 1 bit } outcomeInRam_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_taskId \
    op interface \
    ports { taskId_dout { I 8 vector } taskId_num_data_valid { I 6 vector } taskId_fifo_cap { I 6 vector } taskId_empty_n { I 1 bit } taskId_read { O 1 bit } } \
} "
}
