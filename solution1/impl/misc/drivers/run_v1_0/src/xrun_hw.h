...
#define XRUN_CONTROL_ADDR_REALTASKID_BASE     0x00100
#define XRUN_CONTROL_ADDR_REALTASKID_HIGH     0x001ff
#define XRUN_CONTROL_WIDTH_REALTASKID         16
#define XRUN_CONTROL_DEPTH_REALTASKID         128
#define XRUN_CONTROL_ADDR_N_REGIONS_IN_BASE   0x00200
#define XRUN_CONTROL_ADDR_N_REGIONS_IN_HIGH   0x002ff
